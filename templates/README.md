# Deployit Open Source Templates

This is the official repository for the Deployit Open Source Templates.
...
8. Every PR will automatically deploy a preview of the template to Deployit.
...
Deployit use a defined structure for the `template.toml` file, we have 4 sections available:
